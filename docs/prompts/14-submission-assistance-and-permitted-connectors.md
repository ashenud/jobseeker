...
Run this prompt as fresh context step **14**. After this prompt is complete, committed, continue to the next prompt sequentially.
...
- [ ] `artifacts/verification/milestone-14.json` identifies the tested commit, commands, exit codes, test counts, acceptance IDs, and reviewer verdict.
