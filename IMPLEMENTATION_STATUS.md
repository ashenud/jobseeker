...
**Current milestone:** 02 (`READY`)
**Last completed milestone:** 01
**Overall state:** Milestone 01 is accepted. The frozen charter, manual submission
boundary, Docker-only ADRs, conditional integrations, main/clean 101-test evidence,
empty checkout status, receipt, and independent GO all passed.
...
| 02 | Compliance and platform policy registry | READY | Policy models/config/tests | Not run |
